...
const Sidebar: React.FC = () => {
  ...
  const menuItems = [
    ...
    { path: '/auditoria',      label: 'Auditoría',      icon: 'bi-journal-text' },
    { path: '/servicios',     label: 'Servicios',     icon: 'bi-hdd-stack' },
    { path: '/reportes',      label: 'Reportes',      icon: 'bi-file-earmark-pdf' },
  ];
