  ...
  return (
    <div className="page-shell container-fluid p-2 p-md-4">
      <div className="page-hero mb-4">
        ...
        <p className="page-hero-subtitle">Administra y registra la información detallada de los alumnos</p>
      </div>
        ...
        <div className="card dashboard-card">
          <div className="card-header" style={{ background: 'rgba(102, 126, 234, 0.05)', borderBottom: '1px solid rgba(102, 126, 234, 0.1)', padding: '16px 20px' }}>
            <div className="d-flex justify-content-between align-items-center">
              <h5 className="mb-0 fw-bold text-dark">Listado de Alumnos ({alumnos.length})</h5>
              {allowCreate && (
                <button
